...
pub struct R(hR<DCR_SPEC>);
impl core::ops::Deref for R {
    type Target = hR<DCR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<hR<DCR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: hR<DCR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DCR` writer"]
pub struct W(hW<DCR_SPEC>);
impl core::ops::Deref for W {
    type Target = hW<DCR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<hW<DCR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: hW<DCR_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `FSIZE` reader - FLASH memory size"]
pub struct FSIZE_R(FieldReader<u8, u8>);
impl FSIZE_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        FSIZE_R(FieldReader::new(bits))
    }
}
...
pub struct CSHT_R(FieldReader<u8, u8>);
impl CSHT_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        CSHT_R(FieldReader::new(bits))
    }
}
...
pub struct CKMODE_R(FieldReader<bool, bool>);
impl CKMODE_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        CKMODE_R(FieldReader::new(bits))
    }
}
