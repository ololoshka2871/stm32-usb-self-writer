...
pub struct R(hR<CR_SPEC>);
impl core::ops::Deref for R {
    type Target = hR<CR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<hR<CR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: hR<CR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CR` writer"]
pub struct W(hW<CR_SPEC>);
impl core::ops::Deref for W {
    type Target = hW<CR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<hW<CR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: hW<CR_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `PRESCALER` reader - Clock prescaler"]
pub struct PRESCALER_R(FieldReader<u8, u8>);
impl PRESCALER_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        PRESCALER_R(FieldReader::new(bits))
    }
}
...
pub struct PMM_R(FieldReader<bool, bool>);
impl PMM_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        PMM_R(FieldReader::new(bits))
    }
}
...
pub struct APMS_R(FieldReader<bool, bool>);
impl APMS_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        APMS_R(FieldReader::new(bits))
    }
}
...
pub struct TOIE_R(FieldReader<bool, bool>);
impl TOIE_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        TOIE_R(FieldReader::new(bits))
    }
}
...
pub struct SMIE_R(FieldReader<bool, bool>);
impl SMIE_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        SMIE_R(FieldReader::new(bits))
    }
}
...
pub struct FTIE_R(FieldReader<bool, bool>);
impl FTIE_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        FTIE_R(FieldReader::new(bits))
    }
}
...
pub struct TCIE_R(FieldReader<bool, bool>);
impl TCIE_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        TCIE_R(FieldReader::new(bits))
    }
}
...
pub struct TEIE_R(FieldReader<bool, bool>);
impl TEIE_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        TEIE_R(FieldReader::new(bits))
    }
}
...
pub struct FTHRES_R(FieldReader<u8, u8>);
impl FTHRES_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        FTHRES_R(FieldReader::new(bits))
    }
}
...
pub struct FSEL_R(FieldReader<bool, bool>);
impl FSEL_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        FSEL_R(FieldReader::new(bits))
    }
}
...
pub struct DFM_R(FieldReader<bool, bool>);
impl DFM_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        DFM_R(FieldReader::new(bits))
    }
}
...
pub struct SSHIFT_R(FieldReader<bool, bool>);
impl SSHIFT_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        SSHIFT_R(FieldReader::new(bits))
    }
}
...
pub struct TCEN_R(FieldReader<bool, bool>);
impl TCEN_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        TCEN_R(FieldReader::new(bits))
    }
}
...
pub struct DMAEN_R(FieldReader<bool, bool>);
impl DMAEN_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        DMAEN_R(FieldReader::new(bits))
    }
}
...
pub struct ABORT_R(FieldReader<bool, bool>);
impl ABORT_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        ABORT_R(FieldReader::new(bits))
    }
}
...
pub struct EN_R(FieldReader<bool, bool>);
impl EN_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        EN_R(FieldReader::new(bits))
    }
}
...
pub struct CR_SPEC;
impl RegisterSpec for CR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cr::R](R) reader structure"]
impl Readable for CR_SPEC {
    type Reader = R;
}
